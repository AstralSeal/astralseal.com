...
const translations = {
  ...
  th: {
    ...
    overview_text: "เกมวิชวลโนเวลเรื่องที่ 4 จากผู้สร้าง Re:Fragment ~Absolute Ambition~ ใน Dimension Rift: Otaku Save The World ความวุ่นวายเกิดขึ้นเมื่อตัวละครอนิเมะหนีออกมาสู่โลกแห่งความจริง! ร่วมมือกับโอตาคุระดับตำนานและผู้พิทักษ์โลกอนิเมะในภารกิจค้นหา \"Edith\" ปากกาวิเศษที่สามารถเขียนเรื่องราวใดๆ ใหม่ได้! ติดตามการผจญภัยของโอตาคุที่ต้องช่วยโลกในแบบที่ไม่เคยมีอนิเมะเรื่องไหนทำมาก่อน!",

    // Story Section
    story_title: "เรื่องราว",
    story_p1: "เมื่อ \"Edith\" ปากกาลึกลับที่สามารถเขียนเรื่องราวของโลกอนิเมะใหม่ได้ถูกขโมยไป โลกแห่งความจริงต้องเผชิญกับความวุ่นวายเมื่อรอยแยกมิติเปิดขึ้น ทำให้ตัวละครอนิเมะหลั่งไหลเข้ามาสู่โลกจริง",
    ...
    story_p3: "ที่แย่กว่านั้นคือวิธีเดียวที่จะส่งตัวละครเหล่านี้กลับไปยังโลกของพวกเขาคือ \"ทำให้พวกเขาหลงรัก\" ยูกิและเพื่อนๆ จะสามารถทำให้ตัวละครทั้งหมดหลงรักและปกป้องทั้งสองโลกได้หรือไม่? หรือทุกอย่างจะถูกเขียนใหม่... โดยปากกา Edith?",
    ...
    char_lecia_desc: "ผู้พิทักษ์สมดุลของโลกอนิเมะที่ยังเยาว์วัย แม้จะมีตำแหน่งสูงส่งและความรับผิดชอบมากมาย แต่เธอก็ค่อนข้างเงอะงะเมื่อต้องเจอเทคโนโลยีของโลกมนุษย์ เธอถือครองปากกา \"Edith\" ในตำนานที่สามารถเขียนเรื่องราวอนิเมะใหม่ได้",
